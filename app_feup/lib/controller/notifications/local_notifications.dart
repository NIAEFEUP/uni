...
class LocalNotifications {
  ...
  bool flagDueNotification = true;

  start() {
    if (! flagDueNotification) return;
    flagDueNotification = false;
  ...
  static pushNotification(
    ...
    const AndroidNotificationDetails androidNotificationDetails =
      ...
      'uni',
      'uNi',
      'Notifications for uNi by NIAEFEUP',
    ...
    _instance.show(0, title, body, platformSpecificDetails, payload: payload);
  }
}
