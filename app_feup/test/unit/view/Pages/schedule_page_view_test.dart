...
void main() {
  group('ExamsPage', () {
    ...
    final teacher1 = 'JAS';
    final day1 = 0;
    final lecture1 = Lecture.secConstructor(
        subject1, typeClass1, day1, startTime1, blocks, room1, teacher1);
    final subject2 = 'SDIS';
    ...
    final teacher2 = 'PMMS';
    final day2 = 0;
    final lecture2 = Lecture.secConstructor(
        subject2, typeClass2, day2, startTime2, blocks, room2, teacher2);
    final subject3 = 'AMAT';
    ...
    final teacher3 = 'PMMS';
    final day3 = 1;
    final lecture3 = Lecture.secConstructor(
        subject3, typeClass3, day3, startTime3, blocks, room3, teacher3);
    final subject4 = 'PROG';
    ...
    final teacher4 = 'JAS';
    final day4 = 2;
    final lecture4 = Lecture.secConstructor(
        subject4, typeClass4, day4, startTime4, blocks, room4, teacher4);
    final subject5 = 'PPIN';
    ...
    final teacher5 = 'SSN';
    final day5 = 3;
    final lecture5 = Lecture.secConstructor(
        subject5, typeClass5, day5, startTime5, blocks, room5, teacher5);
    final subject6 = 'SDIS';
    ...
    final teacher6 = 'PMMS';
    final day6 = 4;
    final lecture6 = Lecture.secConstructor(
        subject6, typeClass6, day6, startTime6, blocks, room6, teacher6);
