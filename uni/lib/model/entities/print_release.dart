...
class PrintRelease {
  ...
  PrintRelease(this.filename, this.datetime, this.cost, this.pages, this.size,
      this.colors, this._cancelUrl);

  /// Creates a new instance from a JSON object.
  static PrintRelease fromParser(
    ...
    return PrintRelease(
      filename,
      DateFormat('dd/MM/yyyy HH:mm').parse(datetime), //TODO: needs to parse "Nov 8, 2022 3:17:39 PM"
  ...
  /// Creates a new instance from a JSON object
  PrintRelease.fromJson(Map<String, dynamic> json)
  ...
  //cancel print release
  Future cancel(Session session) async{
    final String url = printURL + _cancelUrl;
