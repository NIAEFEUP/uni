...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(dynamic time) => "última atualização às ${time}";

  static String m1(dynamic time) => Intl.plural(
        time as num,
        zero: 'Atualizado há ${time} minutos',
        one: 'Atualizado há ${time} minuto',
        other: 'Atualizado há ${time} minutos',
      );
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "agree_terms": MessageLookupByLibrary.simpleMessage(
          "Ao entrares confirmas que concordas "
        ...
        "buses_text": MessageLookupByLibrary.simpleMessage(
            "Os autocarros favoritos serão apresentados no widget "
            "'Autocarros' dos favoritos. "
