...
void main() {
  group('ExamsPage', () {
    ...
    final teacher4 = 'JAS';
    final day4 = 2;
    final occurrId4 = 484422;
    final lecture4 = Lecture.fromHtml(subject4, typeClass4, day4,
        startTime4, blocks, room4, teacher4, classNumber, occurrId4);
    final subject5 = 'PPIN';
    ...
    final teacher5 = 'SSN';
    final day5 = 3;
    final occurrId5 = 47775;
    final lecture5 = Lecture.fromHtml(subject5, typeClass5, day5,
        startTime5, blocks, room5, teacher5, classNumber, occurrId5);
    final subject6 = 'SDIS';
    ...
    final teacher6 = 'PMMS';
    final day6 = 4;
    final occurrId6 = 12345;
    final lecture6 = Lecture.fromHtml(subject6, typeClass6, day6,
        startTime6, blocks, room6, teacher6, classNumber, occurrId6);
