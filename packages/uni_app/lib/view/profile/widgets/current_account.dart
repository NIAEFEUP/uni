      ...
      data: (data) {
        ...
        return Column(
          children: [
            ...
            if (_selectedTab == 1) CertificateTable(data: certificate),
            if (_selectedTab == 2)
              LatePaymentInterestTable(data: latePaymentInterest),
            if (_selectedTab == 3) TuitionFeesTable(data: tuitionFees),
            if (_selectedTab == 4) SchoolInsuranceTable(data: schoolInsurance),
            if (_selectedTab == 5)
