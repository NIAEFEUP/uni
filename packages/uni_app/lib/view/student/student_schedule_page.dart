...
import 'package:uni/model/providers/riverpod/student_lectures_provider.dart';
...
class StudentSchedulePage extends ConsumerWidget {
  StudentSchedulePage({super.key, required this.student, DateTime? now})
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return MediaQuery.removePadding(
      ...
      child: DefaultConsumer<List<Lecture>>(
        provider: studentLecturesProvider((student, null)),
...
class StudentSchedulePageView extends ConsumerStatefulWidget {
  const StudentSchedulePageView(this.student, {super.key});

  final CourseUnitStudent student;

  @override
  ConsumerState<StudentSchedulePageView> createState() =>
      _StudentSchedulePageViewState();
}

class _StudentSchedulePageViewState
    extends SecondaryPageViewState<StudentSchedulePageView> {
  @override
  Future<void> onRefresh() async {
    ref.invalidate(studentLecturesProvider((widget.student, null)));
  }

  @override
  String? getTitle() => widget.student.name;

  @override
  Widget getBody(BuildContext context) {
    return StudentSchedulePage(student: widget.student);
  }
}
